  ...
  return (
    <div style={styles.page}>
      <style jsx global>{`
        ...
        @keyframes zoomPan { 0% { transform: scale(1.1) translateY(0px); } 100% { transform: scale(1.25) translateY(-20px); } }
      ...
      <div style={styles.card}>
        ...
        {stage === 3 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p style={styles.pBig}>
              Bhumi, you are one of the most special people in my life...
            </p>
        ...
        {stage === 4 && (
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
            <h1 style={{...styles.h1, textShadow: "0 0 25px #4fc3f7"}}>
